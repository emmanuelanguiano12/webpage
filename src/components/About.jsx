    ...
    <section id="about" className="min-h-screen px-6 md:px-24 py-16">
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
            ...
            <p className="text-lg text-gray-800 leading-7 mb-4">
                Hi! My name is <span className="font-bold">Emmanuel Anguiano</span>. I'm a Fullstack Developer, currently working at <span className="font-semibold">Rappi Technologies</span> as an AI Developer.
            </p>
            <p className="text-lg text-gray-800 leading-7 mb-4">
